 ...
 * @subpackage api.enum
 */
class VidiunESearchEntryFieldName extends VidiunStringEnum
{
	const ID = 'id';
	const NAME = 'name';
	const DESCRIPTION = 'description';
	const TAGS = 'tags';
	const USER_ID = 'vuser_id';
	const CREATOR_ID = 'creator_vuser_id';
	const START_DATE = 'start_date';
	const END_DATE = 'end_date';
	const REFERENCE_ID = 'reference_id';
	const CONVERSION_PROFILE_ID = 'conversion_profile_id';
	const REDIRECT_ENTRY_ID = 'redirect_entry_id';
	const ENTITLED_USER_EDIT = 'entitled_vusers_edit';
	const ENTITLED_USER_PUBLISH = 'entitled_vusers_publish';
	const ENTITLED_USER_VIEW = 'entitled_vusers_view';
