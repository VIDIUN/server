 ...
 * @subpackage admin
 */
class Vidiun_View_Helper_EntryInvestigateAttachmentAssets extends Vidiun_View_Helper_PartialViewPlugin
{
	private $entryId;
	private $partnerId;
	...
	protected function getDataArray()
	{
		...
		$attachmentPlugin = Vidiun_Client_Attachment_Plugin::get($client);
		$fileSyncPlugin = Vidiun_Client_FileSync_Plugin::get($client);
		
		$filter = new Vidiun_Client_Attachment_Type_AttachmentAssetFilter();
