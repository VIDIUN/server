...
/**
 * Base class that represents a row from the 'business_process_server' table.
 *
 * 
 *
 ...
 * @subpackage model.om
 */
abstract class BaseBusinessProcessServer extends BaseObject  implements Persistent {
	...
	{
		if(!isset($this->oldColumnsValues[BusinessProcessServerPeer::ID]))
			$this->oldColumnsValues[BusinessProcessServerPeer::ID] = $this->id;
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = BusinessProcessServerPeer::ID;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = BusinessProcessServerPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = BusinessProcessServerPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	{
		if(!isset($this->oldColumnsValues[BusinessProcessServerPeer::PARTNER_ID]))
			$this->oldColumnsValues[BusinessProcessServerPeer::PARTNER_ID] = $this->partner_id;
		...
		if ($this->partner_id !== $v) {
			$this->partner_id = $v;
			$this->modifiedColumns[] = BusinessProcessServerPeer::PARTNER_ID;
		}
	...
	{
		if(!isset($this->oldColumnsValues[BusinessProcessServerPeer::NAME]))
			$this->oldColumnsValues[BusinessProcessServerPeer::NAME] = $this->name;
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = BusinessProcessServerPeer::NAME;
		}
	...
	{
		if(!isset($this->oldColumnsValues[BusinessProcessServerPeer::SYSTEM_NAME]))
			$this->oldColumnsValues[BusinessProcessServerPeer::SYSTEM_NAME] = $this->system_name;
		...
		if ($this->system_name !== $v) {
			$this->system_name = $v;
			$this->modifiedColumns[] = BusinessProcessServerPeer::SYSTEM_NAME;
		}
	...
	{
		if(!isset($this->oldColumnsValues[BusinessProcessServerPeer::DESCRIPTION]))
			$this->oldColumnsValues[BusinessProcessServerPeer::DESCRIPTION] = $this->description;
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = BusinessProcessServerPeer::DESCRIPTION;
		}
	...
	{
		if(!isset($this->oldColumnsValues[BusinessProcessServerPeer::STATUS]))
			$this->oldColumnsValues[BusinessProcessServerPeer::STATUS] = $this->status;
		...
		if ($this->status !== $v) {
			$this->status = $v;
			$this->modifiedColumns[] = BusinessProcessServerPeer::STATUS;
		}
	...
	{
		if(!isset($this->oldColumnsValues[BusinessProcessServerPeer::TYPE]))
			$this->oldColumnsValues[BusinessProcessServerPeer::TYPE] = $this->type;
		...
		if ($this->type !== $v) {
			$this->type = $v;
			$this->modifiedColumns[] = BusinessProcessServerPeer::TYPE;
		}
	...
	public function setCustomData($v)
	{
		...
		if ($this->custom_data !== $v) {
			$this->custom_data = $v;
			$this->modifiedColumns[] = BusinessProcessServerPeer::CUSTOM_DATA;
		}
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				BusinessProcessServerPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			$this->postSave($con);
			BusinessProcessServerPeer::addInstanceToPool($this);
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = BusinessProcessServerPeer::doInsert($this, $con);
					...
					$affectedObjects = BusinessProcessServerPeer::doUpdate($this, $con);
					if($affectedObjects)
						$this->objectSaved = true;
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = BusinessProcessServerPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = BusinessProcessServerPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = BusinessProcessServerPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(BusinessProcessServerPeer::ID)) $criteria->add(BusinessProcessServerPeer::ID, $this->id);
		if ($this->isColumnModified(BusinessProcessServerPeer::CREATED_AT)) $criteria->add(BusinessProcessServerPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(BusinessProcessServerPeer::UPDATED_AT)) $criteria->add(BusinessProcessServerPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(BusinessProcessServerPeer::PARTNER_ID)) $criteria->add(BusinessProcessServerPeer::PARTNER_ID, $this->partner_id);
		if ($this->isColumnModified(BusinessProcessServerPeer::NAME)) $criteria->add(BusinessProcessServerPeer::NAME, $this->name);
		if ($this->isColumnModified(BusinessProcessServerPeer::SYSTEM_NAME)) $criteria->add(BusinessProcessServerPeer::SYSTEM_NAME, $this->system_name);
		if ($this->isColumnModified(BusinessProcessServerPeer::DESCRIPTION)) $criteria->add(BusinessProcessServerPeer::DESCRIPTION, $this->description);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(BusinessProcessServerPeer::ID, $this->id);
		
		if($this->alreadyInSave)
		{
			if ($this->isColumnModified(BusinessProcessServerPeer::CUSTOM_DATA))
			{
				if (!is_null($this->custom_data_md5))
					$criteria->add(BusinessProcessServerPeer::CUSTOM_DATA, "MD5(cast(" . BusinessProcessServerPeer::CUSTOM_DATA . " as char character set latin1)) = '$this->custom_data_md5'", Criteria::CUSTOM);
					//casting to latin char set to avoid mysql and php md5 difference
				else 
					$criteria->add(BusinessProcessServerPeer::CUSTOM_DATA, NULL, Criteria::ISNULL);
			}
			
			if (count($this->modifiedColumns) == 2 && $this->isColumnModified(BusinessProcessServerPeer::UPDATED_AT))
			{
				$theModifiedColumn = null;
				foreach($this->modifiedColumns as $modifiedColumn)
					if($modifiedColumn != BusinessProcessServerPeer::UPDATED_AT)
						$theModifiedColumn = $modifiedColumn;
						
				$atomicColumns = BusinessProcessServerPeer::getAtomicColumns();
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of BusinessProcessServer (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     BusinessProcessServer Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @var     BusinessProcessServer Clone of current object.
	 */
	 ...
	 * Stores the source object that this object copied from 
	 *
	 * @param      BusinessProcessServer $copiedFrom Clone of current object.
	 */
	public function setCopiedFrom(BusinessProcessServer $copiedFrom)
	{
	 ...
	 *
	 * @return     BusinessProcessServerPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new BusinessProcessServerPeer();
		}
		return self::$peer;
	}
