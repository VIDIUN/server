 ...
 */
class TranscriptAssetEventNotificationsPlugin extends VidiunPlugin implements IVidiunPending, IVidiunEnumerator, IVidiunObjectLoader
{
	...
	public static function dependsOn()
	{
		...
		$transcriptAssetDependency = new VidiunDependency(self::TRANSCRIPT_ASSET_PLUGIN_NAME);
