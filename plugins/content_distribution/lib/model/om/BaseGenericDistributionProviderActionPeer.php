...
abstract class BaseGenericDistributionProviderActionPeer {
	...
	{		
		$criteriaForSelect = GenericDistributionProviderActionPeer::prepareCriteriaForSelect($criteria);
		...
		$queryResult = GenericDistributionProviderActionPeer::populateObjects(BasePeer::doSelect($criteriaForSelect, $con));
	...
	public static function &getCriteriaFilter()
	{
		...
		$partnerCriteria = myPartnerUtils::getPartnerCriteriaParams('GenericDistributionProviderAction');
		if ($partnerCriteria)
		{
			call_user_func_array(array('GenericDistributionProviderActionPeer','addPartnerToCriteria'), $partnerCriteria);
		}
	...
	public static function addInstanceToPool(GenericDistributionProviderAction $obj, $key = null)
	{
		if ( Propel::isInstancePoolingEnabled() )
		{
				...
				)
			{
				...
				vMemoryManager::registerPeer('GenericDistributionProviderActionPeer');
			}
		}
	}
