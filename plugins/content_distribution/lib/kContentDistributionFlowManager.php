 ...
 * @subpackage lib
 */
class vContentDistributionFlowManager extends vContentDistributionManager implements vObjectChangedEventConsumer, vObjectCreatedEventConsumer, vBatchJobStatusEventConsumer, vObjectDeletedEventConsumer, vObjectUpdatedEventConsumer, vObjectAddedEventConsumer, vObjectDataChangedEventConsumer
{
	/* (non-PHPdoc)
	...
	public function objectChanged(BaseObject $object, array $modifiedColumns)
	{
		...
		if($object instanceof asset && $object->getStatus() == asset::FLAVOR_ASSET_STATUS_READY)
		{
			...
			VidiunLog::log("Status and version didn't change");
		}
	...
	public function objectAdded(BaseObject $object, BatchJob $raisedJob = null)
	{
		...
		if($entry) // updated in the indexing server (sphinx)
			vEventsManager::raiseEvent(new vObjectUpdatedEvent($entry, $raisedJob));
	 ...
	 * @param vDistributionSubmitJobData $data
	 * @return BatchJob
	 */
	public static function onDistributionSubmitJobUpdated(BatchJob $dbBatchJob, vDistributionSubmitJobData $data)
	{
		if($data->getRemoteId() || $data->getResults() || $data->getSentData() || $data->getMediaFiles())
		{
			...
			if($data->getResults())
			{
				...
				vFileSyncUtils::file_put_contents($key, $data->getResults());
			...
			if($data->getSentData())
			{
				...
				vFileSyncUtils::file_put_contents($key, $data->getSentData());
	...
	/**
	 * @param BatchJob $dbBatchJob
	 * @param vDistributionUpdateJobData $data
	 * @return BatchJob
	 */
	public static function onDistributionUpdateJobUpdated(BatchJob $dbBatchJob, vDistributionUpdateJobData $data)
	{
	 ...
	 * @return BatchJob
	 */
	public static function onDistributionEnableJobUpdated(BatchJob $dbBatchJob, vDistributionUpdateJobData $data)
	{
	 ...
	 * @return BatchJob
	 */
	public static function onImportJobUpdated(BatchJob $dbBatchJob, vImportJobData $data)
	{
		switch($dbBatchJob->getStatus())
		{
			case BatchJob::BATCHJOB_STATUS_FINISHED:
	 ...
	 * @return BatchJob
	 */
	public static function onDistributionDisableJobUpdated(BatchJob $dbBatchJob,vDistributionUpdateJobData $data)
	{
		if($data->getResults() || $data->getSentData())
		{
			$entryDistribution = EntryDistributionPeer::retrieveByPK($data->getEntryDistributionId());
	...
	/**
	 * @param BatchJob $dbBatchJob
	 * @param vDistributionDeleteJobData $data
	 * @return BatchJob
	 */
	public static function onDistributionDeleteJobUpdated(BatchJob $dbBatchJob, vDistributionDeleteJobData $data)
	{
		if($data->getResults() || $data->getSentData())
		{
			$entryDistribution = EntryDistributionPeer::retrieveByPK($data->getEntryDistributionId());
	 ...
	 * @return BatchJob
	 */
	public static function onDistributionSubmitJobPending(BatchJob $dbBatchJob, vDistributionSubmitJobData $data)
	{
	 ...
	 * @return BatchJob
	 */
	public static function onDistributionUpdateJobPending(BatchJob $dbBatchJob, vDistributionUpdateJobData $data)
	{
		if($data->getProviderType() == DistributionProviderType::SYNDICATION)
		{
			$dbBatchJob = vJobsManager::updateBatchJob($dbBatchJob, BatchJob::BATCHJOB_STATUS_FINISHED);
	 ...
	 * @return BatchJob
	 */
	public static function onDistributionEnableJobPending(BatchJob $dbBatchJob, vDistributionUpdateJobData $data)
	{
		if($data->getProviderType() == DistributionProviderType::SYNDICATION)
		{
			$dbBatchJob = vJobsManager::updateBatchJob($dbBatchJob, BatchJob::BATCHJOB_STATUS_FINISHED);
	 ...
	 * @return BatchJob
	 */
	public static function onDistributionDisableJobPending(BatchJob $dbBatchJob, vDistributionUpdateJobData $data)
	{
		if($data->getProviderType() == DistributionProviderType::SYNDICATION)
		{
			$dbBatchJob = vJobsManager::updateBatchJob($dbBatchJob, BatchJob::BATCHJOB_STATUS_FINISHED);
	 ...
	 * @return BatchJob
	 */
	public static function onDistributionDeleteJobPending(BatchJob $dbBatchJob, vDistributionDeleteJobData $data)
	{
		if($data->getProviderType() == DistributionProviderType::SYNDICATION)
		{
			$dbBatchJob = vJobsManager::updateBatchJob($dbBatchJob, BatchJob::BATCHJOB_STATUS_FINISHED);
	 ...
	 * @return BatchJob
	 */
	public static function onDistributionSubmitJobFinished(BatchJob $dbBatchJob, vDistributionSubmitJobData $data)
	{
		$entryDistribution = EntryDistributionPeer::retrieveByPK($data->getEntryDistributionId());
		if(!$entryDistribution)
		{
		...
		{
			VidiunLog::err("Entry distribution [" . $entryDistribution->getId() . "] profile [$distributionProfileId] not found");
			return $dbBatchJob;
		}
	 ...
	 * @return BatchJob
	 */
	public static function onDistributionUpdateJobFinished(BatchJob $dbBatchJob, vDistributionUpdateJobData $data)
	{
		$entryDistribution = EntryDistributionPeer::retrieveByPK($data->getEntryDistributionId());
		if(!$entryDistribution)
		{
	 ...
	 * @return BatchJob
	 */
	public static function onDistributionEnableJobFinished(BatchJob $dbBatchJob, vDistributionUpdateJobData $data)
	{
		$entryDistribution = EntryDistributionPeer::retrieveByPK($data->getEntryDistributionId());
		if(!$entryDistribution)
		{
	 ...
	 * @return BatchJob
	 */
	public static function onImportJobFinished(BatchJob $dbBatchJob, vImportJobData $data)
	{
		$statuses = array(
		...
		foreach($entryDistributions as $entryDistribution)
		{
			...
			{
				VidiunLog::notice("Submitting add entry distribution [" . $entryDistribution->getId() . "]");
				vContentDistributionManager::submitAddEntryDistribution($entryDistribution, $distributionProfile, true);
			}
			elseif($entryDistribution->getStatus() == EntryDistributionStatus::IMPORT_UPDATING)
			{
				VidiunLog::notice("Submitting update entry distribution [" . $entryDistribution->getId() . "]");
				vContentDistributionManager::submitUpdateEntryDistribution($entryDistribution, $distributionProfile);	
			}
		}
	}
	 ...
	 * @return BatchJob
	 */
	public static function onImportJobFailed(BatchJob $dbBatchJob, vImportJobData $data)
	{
		$statuses = array(
			EntryDistributionStatus::IMPORT_SUBMITTING,
			EntryDistributionStatus::IMPORT_UPDATING,
	 ...
	 * @return BatchJob
	 */
	public static function onDistributionDisableJobFinished(BatchJob $dbBatchJob, vDistributionUpdateJobData $data)
	{
		$entryDistribution = EntryDistributionPeer::retrieveByPK($data->getEntryDistributionId());
		if(!$entryDistribution)
		{
	 ...
	 * @return BatchJob
	 */
	public static function onDistributionDeleteJobFinished(BatchJob $dbBatchJob, vDistributionDeleteJobData $data)
	{
		$entryDistribution = EntryDistributionPeer::retrieveByPK($data->getEntryDistributionId());
		if(!$entryDistribution)
		{
	 ...
	 * @return BatchJob
	 */
	public static function onDistributionSubmitJobAborted(BatchJob $dbBatchJob, vDistributionSubmitJobData $data)
	{
	 ...
	 * @return BatchJob
	 */
	public static function onDistributionUpdateJobAborted(BatchJob $dbBatchJob, vDistributionSubmitJobData $data)
	{
	 ...
	 * @param $status
	 */
	private static function updateDistributionStatus(vDistributionSubmitJobData $data, $status)
	{
		$entryDistribution = EntryDistributionPeer::retrieveByPK($data->getEntryDistributionId());
		if(!$entryDistribution)
		{
	 ...
	 * @return BatchJob
	 */
	public static function onDistributionSubmitJobFailed(BatchJob $dbBatchJob, vDistributionSubmitJobData $data)
	{
		$entryDistribution = EntryDistributionPeer::retrieveByPK($data->getEntryDistributionId());
		if(!$entryDistribution)
		{
	 ...
	 * @return BatchJob
	 */
	public static function onDistributionUpdateJobFailed(BatchJob $dbBatchJob, vDistributionUpdateJobData $data)
	{
		$entryDistribution = EntryDistributionPeer::retrieveByPK($data->getEntryDistributionId());
		if(!$entryDistribution)
		{
	 ...
	 * @return BatchJob
	 */
	public static function onDistributionEnableJobFailed(BatchJob $dbBatchJob, vDistributionUpdateJobData $data)
	{
		$entryDistribution = EntryDistributionPeer::retrieveByPK($data->getEntryDistributionId());
		if(!$entryDistribution)
		{
	 ...
	 * @return BatchJob
	 */
	public static function onDistributionDisableJobFailed(BatchJob $dbBatchJob, vDistributionUpdateJobData $data)
	{
		$entryDistribution = EntryDistributionPeer::retrieveByPK($data->getEntryDistributionId());
		if(!$entryDistribution)
		{
	 ...
	 * @return BatchJob
	 */
	public static function onDistributionDeleteJobFailed(BatchJob $dbBatchJob, vDistributionDeleteJobData $data)
	{
		$entryDistribution = EntryDistributionPeer::retrieveByPK($data->getEntryDistributionId());
		if(!$entryDistribution)
		{
	...
	public static function onMetadataDeleted(Metadata $metadata)
	{
		...
		VidiunLog::log("Metadata [" . $metadata->getId() . "] for entry [" . $metadata->getObjectId() . "] deleted");
		
		$entry = entryPeer::retrieveByPK($metadata->getObjectId());
		if (!$entry || $entry->getStatus() == entryStatus::DELETED){
			VidiunLog::info("Entry [".$metadata->getObjectId()."] not found or deleted");
			return true; 
		}
		...
		foreach($entryDistributions as $entryDistribution)
		{
			...
			{
				VidiunLog::err("Entry distribution [" . $entryDistribution->getId() . "] provider [" . $distributionProfile->getProviderType() . "] not found");
				continue;
			}
			...
			if($entryDistribution->getStatus() == EntryDistributionStatus::READY)
			{
				...
				{
					VidiunLog::log("Entry distribution [" . $entryDistribution->getId() . "] already flaged for updating");
//					continue;
				}
				...
				{
					VidiunLog::log("Entry distribution [" . $entryDistribution->getId() . "] profile id  [" . $distributionProfile->getId() . "] update not enabled");
					continue;
				}
				...
				{
					VidiunLog::log("Entry distribution [" . $entryDistribution->getId() . "] should not be updated automatically");
	...
	public static function onMetadataChanged(Metadata $metadata, $previousVersion)
	{
		...
		if(!$entry)
		{
			VidiunLog::info("Entry [".$entryId."] not found");
			return true;
		}
		...
		VidiunLog::log("Metadata [" . $metadata->getId() . "] for entry [" . $metadata->getObjectId() . "] changed");
		
		$syncKey = $metadata->getSyncKey(Metadata::FILE_SYNC_METADATA_DATA);
		$xmlString = vFileSyncUtils::file_get_contents($syncKey);
		if(!$xmlString)
		{
			VidiunLog::err("Entry metadata xml not found");
			return true;
		}
...
//					continue;
				...
				if(!$updateRequired)
				{
					VidiunLog::log("Entry distribution [" . $entryDistribution->getId() . "] update not required");
					continue;	
				}				
	...
	public static function onEntryDistributionUpdateRequired(EntryDistribution $entryDistribution)
	{
		...
		{			
			VidiunLog::log("Entry distribution [" . $entryDistribution->getId() . "] status [" . $entryDistribution->getStatus() . "] does not require update");
			return true;
		}
		
		if($entryDistribution->getDirtyStatus() == EntryDistributionDirtyStatus::UPDATE_REQUIRED)
		{			
			VidiunLog::log("Entry distribution [" . $entryDistribution->getId() . "] already requires update");
			return true;
		}
		...
		foreach($entryDistributions as $entryDistribution)
		{
			...
			switch($entryDistribution->getStatus())
			{
				...
				case EntryDistributionStatus::REMOVED:
					...
					VidiunLog::log("Entry distribution [" . $entryDistribution->getId() . "] status [" . $entryDistribution->getStatus() . "] no update required");
					continue;
				...
				case EntryDistributionStatus::ERROR_SUBMITTING:	
					...
					VidiunLog::log("Entry distribution [" . $entryDistribution->getId() . "] validation errors [" . print_r($validationErrors, true) . "]");
				...
				default:
					...
					{
						VidiunLog::log("Entry distribution [" . $entryDistribution->getId() . "] already flagged for updating");
//						continue;
					}
					...
					if ($entryDistribution->getStatus() == EntryDistributionStatus::READY)
					{
						...
						{
							/* @var $validationError vDistributionValidationError */
							if ($validationError->getRequiresDelete ())
							{
								VidiunLog::log("Entry distribution [" . $entryDistribution->getId() . "] has a validation error that should trigger its deletion");
								if ($distributionProfile->getDeleteEnabled() == DistributionProfileActionStatus::AUTOMATIC)
								{
									VidiunLog::info("Entry distribution item should not be deleted, but moved back to QUEUED status");
									self::submitDeleteEntryDistribution($entryDistribution, $distributionProfile, true);
									continue;
								}
								else
								{
									VidiunLog::log("Entry distribution [" . $entryDistribution->getId() . "] should not be deleted automatically");
									$entryDistribution->setDirtyStatus(EntryDistributionDirtyStatus::DELETE_REQUIRED);
									$entryDistribution->save();
								}
							}	
					...
					VidiunLog::log("Updating entry distribution [" . $entryDistribution->getId() . "]");
					self::submitUpdateEntryDistribution($entryDistribution, $distributionProfile);
			}
		}
	...
	public static function onEntryDeleted(entry $entry)
	{
		...
		foreach($entryDistributions as $entryDistribution)
		{
			...
			{
				VidiunLog::log("Entry distribution [" . $entryDistribution->getId() . "] already deleting");
				continue;
			}
				
			if($entryDistribution->getDirtyStatus() == EntryDistributionDirtyStatus::DELETE_REQUIRED)
			{
				VidiunLog::log("Entry distribution [" . $entryDistribution->getId() . "] already flagged for deletion");
				continue;
			}
			
			if (!in_array ($entryDistribution->getStatus(), $validStatuses))
			{
				VidiunLog::info("Entry distribution object [" .  $entryDistribution->getId() . "] to be deleted.");
	...
	public static function onEntryReady(entry $entry)
	{
		...
		foreach($distributionProfiles as $distributionProfile)
		{
			...
			if($entryDistribution)
			{
				VidiunLog::info("Found entry distribution object with id [" . $entryDistribution->getId() . "] for distrinution profle [" . $distributionProfile->getId() . "]");
	...
	public static function onAssetVersionChanged(asset $asset)
	{
		...
		{
			VidiunLog::log("Partner [" . $asset->getPartnerId() . "] is not allowed");
			return true;
		}
		...
		if(!$entry)
		{
			VidiunLog::log("Entry [" . $asset->getEntryId() . "] not found");
			return true;
		}
			
		$entryDistributions = EntryDistributionPeer::retrieveWithEnabledProfileByEntryId($asset->getEntryId());
		VidiunLog::log("Entry distributions [" . count($entryDistributions) . "] found");
		...
		foreach($entryDistributions as $entryDistribution)
		{
			...
			if(!$distributionProfile)
			{
				VidiunLog::log("Entry distribution [" . $entryDistribution->getId() . "] profile [" . $entryDistribution->getDistributionProfileId() . "] not found");
				continue;
			}
	...
	public static function onAssetReadyOrDeleted(asset $asset)
	{
		...
		if(!$entry || $entry->getStatus() == entryStatus::DELETED)
		{
			VidiunLog::log("Entry [" . $asset->getEntryId() . "] not found or deleted");
			return true;
		}
		...
		foreach($entryDistributions as $entryDistribution)
		{
			...
			if(!$distributionProfile)
			{
				VidiunLog::log("Entry distribution [" . $entryDistribution->getId() . "] profile [$distributionProfileId] not found");
				continue;
			}
	...
	protected static function assignAssetsAndValidateForSubmission(EntryDistribution $entryDistribution, entry $entry, DistributionProfile $distributionProfile, $action){
		$listChanged = vContentDistributionManager::assignFlavorAssets($entryDistribution, $entry, $distributionProfile);
		$listChanged = ($listChanged | vContentDistributionManager::assignThumbAssets($entryDistribution, $entry, $distributionProfile));
		$listChanged = ($listChanged | vContentDistributionManager::assignAssets($entryDistribution, $entry, $distributionProfile));
		
		if(!$listChanged)
		{
			VidiunLog::log("Entry distribution [" . $entryDistribution->getId() . "] asset lists didn't change");
		}
