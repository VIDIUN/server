 ...
 * @abstract
 */
abstract class VidiunDwhHourlyPartnerBaseFilter extends VidiunFilter
{
	...
	{
		return array_merge(parent::getMapBetweenObjects(), VidiunDwhHourlyPartnerBaseFilter::$map_between_objects);
	}

	public function getOrderByMap()
	{
		return array_merge(parent::getOrderByMap(), VidiunDwhHourlyPartnerBaseFilter::$order_by_map);
	}
