 ...
 */
class VidiunCuePointErrors extends VidiunErrors implements vCuePointErrors
{
	...
	const USER_VS_CANNOT_LIST_RELATED_CUE_POINTS = "USER_VS_CANNOT_LIST_RELATED_CUE_POINTS;FILTER;Cue-points should not be listed [@FILTER@] as related-objects with unprivileged user vs";
