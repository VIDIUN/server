 ...
 */
class CodeCuePointMetadataPlugin extends VidiunPlugin implements IVidiunPending, IVidiunObjectLoader, IVidiunCuePointXmlParser, IVidiunEnumerator
{
	...
	public function getInstance($interface)
	{
		...
		if($interface == 'IVidiunBulkUploadXmlHandler')
			return new MetadataBulkUploadXmlEngineHandler(VidiunMetadataObjectType::CODE_CUE_POINT, 'VidiunCodeCuePoint', 'scene-customData');
