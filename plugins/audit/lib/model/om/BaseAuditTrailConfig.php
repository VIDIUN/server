...
/**
 * Base class that represents a row from the 'audit_trail_config' table.
 *
 * 
 *
 ...
 * @subpackage model.om
 */
abstract class BaseAuditTrailConfig extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the descriptors field.
	 * @var        string
	 */
	...
	/**
	 * Get the [descriptors] column value.
	 * 
	 * @return     string
	 */
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = AuditTrailConfigPeer::ID;
		}
	...
	public function setPartnerId($v)
	{
		...
		if ($this->partner_id !== $v) {
			$this->partner_id = $v;
			$this->modifiedColumns[] = AuditTrailConfigPeer::PARTNER_ID;
		}
	...
	public function setObjectType($v)
	{
		...
		if ($this->object_type !== $v) {
			$this->object_type = $v;
			$this->modifiedColumns[] = AuditTrailConfigPeer::OBJECT_TYPE;
		}
	...
	/**
	 * Set the value of [descriptors] column.
	 * 
	 * @param      string $v new value
	 * @return     AuditTrailConfig The current object (for fluent API support)
	 */
	public function setDescriptors($v)
	{
		...
		if ($this->descriptors !== $v) {
			$this->descriptors = $v;
			$this->modifiedColumns[] = AuditTrailConfigPeer::DESCRIPTORS;
		}
	...
	public function setActions($v)
	{
		...
		if ($this->actions !== $v) {
			$this->actions = $v;
			$this->modifiedColumns[] = AuditTrailConfigPeer::ACTIONS;
		}
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				AuditTrailConfigPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				AuditTrailConfigPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = AuditTrailConfigPeer::doInsert($this, $con);
					...
					$affectedObjects = AuditTrailConfigPeer::doUpdate($this, $con);
					if($affectedObjects)
						$this->objectSaved = true;
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = AuditTrailConfigPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = AuditTrailConfigPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AuditTrailConfigPeer::ID)) $criteria->add(AuditTrailConfigPeer::ID, $this->id);
		if ($this->isColumnModified(AuditTrailConfigPeer::PARTNER_ID)) $criteria->add(AuditTrailConfigPeer::PARTNER_ID, $this->partner_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(AuditTrailConfigPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of AuditTrailConfig (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     AuditTrailConfig Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @var     AuditTrailConfig Clone of current object.
	 */
	 ...
	 * Stores the source object that this object copied from 
	 *
	 * @param      AuditTrailConfig $copiedFrom Clone of current object.
	 */
	public function setCopiedFrom(AuditTrailConfig $copiedFrom)
	{
	 ...
	 *
	 * @return     AuditTrailConfigPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new AuditTrailConfigPeer();
		}
		return self::$peer;
	}
