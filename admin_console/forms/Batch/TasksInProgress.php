...
class Form_Batch_TasksInProgress extends Form_Base
{
	public function init()
	{
		...
		$jobTypes[Vidiun_Client_Enum_BatchJobType::CONVERT_PROFILE] = true;
		$jobTypes[Vidiun_Client_Enum_BatchJobType::POSTCONVERT] = true;
		$jobTypes[Vidiun_Client_Enum_BatchJobType::EXTRACT_MEDIA] = true;
