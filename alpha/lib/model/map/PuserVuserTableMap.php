...
/**
 * This class defines the structure of the 'puser_vuser' table.
 *
 *
 *
 ...
 */
class PuserVuserTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'Core.PuserVuserTableMap';
	...
	{
	  // attributes
		$this->setName('puser_vuser');
		$this->setPhpName('PuserVuser');
		$this->setClassname('PuserVuser');
