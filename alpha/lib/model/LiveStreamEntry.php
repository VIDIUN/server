...
class LiveStreamEntry extends LiveEntry
{
	...
	{
		return $this->getDynamicBroadcastUrl('primaryBroadcastingUrl', 'getPrimaryBroadcastUrl', vBroadcastUrlManager::PROTOCOL_RTMP);
	}
	...
	{
		return $this->getDynamicBroadcastUrl('secondaryBroadcastingUrl', 'getSecondaryBroadcastUrl', vBroadcastUrlManager::PROTOCOL_RTMP);
	}
	...
	{
		return $this->getDynamicBroadcastUrl('primaryRtspBroadcastingUrl', 'getPrimaryBroadcastUrl', vBroadcastUrlManager::PROTOCOL_RTSP);
	}
	...
	{
		return $this->getDynamicBroadcastUrl('secondaryRtspBroadcastingUrl', 'getSecondaryBroadcastUrl', vBroadcastUrlManager::PROTOCOL_RTSP);
	}
	...
	public function getHlsStreamUrl ($protocol = null)
	{
		...
		if($hlsStreamUrl && vString::beginsWith($hlsStreamUrl, 'http://') && $protocol == 'https')
		{
	...
	private function getDynamicBroadcastUrl($customDataParam, $functionName, $protocol)
	{
		...
		$manager = vBroadcastUrlManager::getInstance($this->getPartnerId());
	...
	public function getLiveStreamConfigurations($protocol = 'http', $tag = null, $currentDcOnly = false, array $flavorParamsIds = array(), $format = null)
	{
		...
		if($format == PlaybackProtocol::APPLE_HTTP && !in_array($this->getSource(), self::$vidiunLiveSourceTypes) && $this->getHlsStreamUrl())
		{
