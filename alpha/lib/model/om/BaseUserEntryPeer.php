...
/**
 * Base static class for performing query and update operations on the 'user_entry' table.
 *
 ...
 * @subpackage model.om
 */
abstract class BaseUserEntryPeer {

	/** the default database name for this class */
	const DATABASE_NAME = 'propel';

	/** the table name for this class */
	const TABLE_NAME = 'user_entry';

	/** the related Propel class for this table */
	const OM_CLASS = 'UserEntry';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'Core.UserEntry';
	...
	/**
	 * An identiy map to hold any loaded instances of UserEntry objects.
	 ...
	 * @param      string $column The column name for current table. (i.e. UserEntryPeer::COLUMN_NAME).
	 * @return     string
	 */
	public static function alias($alias, $column)
	{
		return str_replace(UserEntryPeer::TABLE_NAME.'.', $alias.'.', $column);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$con = UserEntryPeer::alternativeCon ($con, $queryDB);
	...
	public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
	{
		...
		$critcopy->setLimit(1);
		$objects = UserEntryPeer::doSelect($critcopy, $con);
		if ($objects) {
			return $objects[0];
		}
		return null;
	...
	public static function updateInstancePool(&$queryResult)
	{
		...
		{
			$objFromPool = UserEntryPeer::getInstanceFromPool($curObject->getPrimaryKey());
			if ($objFromPool === null)
			{
				UserEntryPeer::addInstanceToPool($curObject);
			}
			else
			{
	...
	public static function addInstancesToPool($queryResult)
	{
		if (Propel::isInstancePoolingEnabled())
		{
			...
			{  
				...
				{
					UserEntryPeer::addInstanceToPool($curResult);
				}
			}
		}
	}
	...
	{		
		...
		{
			$cacheKey = null;
			UserEntryPeer::filterSelectResults($cachedResult, $criteriaForSelect);
			UserEntryPeer::updateInstancePool($cachedResult);
			return $cachedResult;
		}
		...
		UserEntryPeer::filterSelectResults($queryResult, $criteria);
		
		UserEntryPeer::addInstancesToPool($queryResult);
		return $queryResult;
	}
	...
	{
		$criteria_filter = UserEntryPeer::getCriteriaFilter();
	...
	public static function &getCriteriaFilter()
	{
		if(self::$s_criteria_filter == null)
			UserEntryPeer::setDefaultCriteriaFilter();
		
		$partnerCriteria = myPartnerUtils::getPartnerCriteriaParams('UserEntry');
		if ($partnerCriteria)
		{
			call_user_func_array(array('UserEntryPeer','addPartnerToCriteria'), $partnerCriteria);
		}
	...
	public static function doCountStmt(Criteria $criteria, PropelPDO $con = null)
	{
		...
		// select the connection for the query
		$con = UserEntryPeer::alternativeCon ( $con );
	...
	public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
	{
		...
		$criteria = UserEntryPeer::prepareCriteriaForSelect($criteria);
	 ...
	 *
	 * @param      UserEntry $value A UserEntry object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(UserEntry $obj, $key = null)
	{
		if ( Propel::isInstancePoolingEnabled() )
		{
			if ( $key === null )
	 ...
	 *
	 * @param      mixed $value A UserEntry object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof UserEntry) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or UserEntry object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     UserEntry Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to user_entry
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = UserEntryPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = UserEntryPeer::getInstanceFromPool($key))) {
				...
				$cls = UserEntryPeer::getOMClass($row, 0);
	...
	public static function doSelectJoinentry(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = UserEntryPeer::getInstanceFromPool($key1))) {
				...
				$omClass = UserEntryPeer::getOMClass($row, 0);
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (UserEntry) to $obj2 (entry)
	...
	/**
	 * Selects a collection of UserEntry objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	/**
	 * Selects a collection of UserEntry objects pre-filled with all related objects except entry.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseUserEntryPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseUserEntryPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new UserEntryTableMap());
	  }
	}
	...
	/**
	 * Method perform an INSERT on the database, given a UserEntry or Criteria object.
	 *
	 * @param      mixed $values Criteria or UserEntry object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from UserEntry object
		}

		if ($criteria->containsKey(UserEntryPeer::ID) && $criteria->keyContainsValue(UserEntryPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.UserEntryPeer::ID.')');
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a UserEntry or Criteria object.
	 *
	 * @param      mixed $values Criteria or UserEntry object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(UserEntryPeer::ID);
			$selectCriteria->add(UserEntryPeer::ID, $criteria->remove(UserEntryPeer::ID), $comparison);

		} else { // $values is UserEntry object
	...
	/**
	 * Method to DELETE all rows from the user_entry table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(UserEntryPeer::TABLE_NAME, $con);
			// Because this db requires some delete cascade/set null emulation, we have to
			// clear the cached instance *after* the emulation has happened (since
			// instances get re-added by the select statement contained therein).
			UserEntryPeer::clearInstancePool();
			UserEntryPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a UserEntry or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or UserEntry object or primary key or array of primary keys
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof UserEntry) { // it's a model object
			// invalidate the cache for this single object
			UserEntryPeer::removeInstanceFromPool($values);
			// create criteria based on pk values
			$criteria = $values->buildPkeyCriteria();
		} else { // it's a primary key, or an array of pks
			$criteria = new Criteria(self::DATABASE_NAME);
			$criteria->add(UserEntryPeer::ID, (array) $values, Criteria::IN);
			// invalidate the cache for this object(s)
			foreach ((array) $values as $singleval) {
				UserEntryPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	/**
	 * Validates all modified columns of given UserEntry object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      UserEntry $obj The object to validate.
	 * @param      mixed $cols Column name or array of column names.
	 *
	 * @return     mixed TRUE if all columns are valid or the error message of the first invalid column.
	 */
	public static function doValidate(UserEntry $obj, $cols = null)
	{
		$columns = array();

		if ($cols) {
			$dbMap = Propel::getDatabaseMap(UserEntryPeer::DATABASE_NAME);
			$tableMap = $dbMap->getTable(UserEntryPeer::TABLE_NAME);
		...
		return BasePeer::doValidate(UserEntryPeer::DATABASE_NAME, UserEntryPeer::TABLE_NAME, $columns);
	}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = UserEntryPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}

		$criteria = new Criteria(UserEntryPeer::DATABASE_NAME);
		$criteria->add(UserEntryPeer::ID, $pk);

		$v = UserEntryPeer::doSelect($criteria, $con);
...
//
BaseUserEntryPeer::buildTableMap();
