...
abstract class BasesyndicationFeedPeer {
	...
	const UPDATED_AT = 'syndication_feed.UPDATED_AT';
	...
	const ENFORCE_ENTITLEMENT = 'syndication_feed.ENFORCE_ENTITLEMENT';

	/** the column name for the PRIVACY_CONTEXT field */
	const PRIVACY_CONTEXT = 'syndication_feed.PRIVACY_CONTEXT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'IntId', 'PartnerId', 'PlaylistId', 'Name', 'Status', 'Type', 'LandingPage', 'FlavorParamId', 'PlayerUiconfId', 'AllowEmbed', 'AdultContent', 'TranscodeExistingContent', 'AddToDefaultConversionProfile', 'Categories', 'FeedDescription', 'Language', 'FeedLandingPage', 'OwnerName', 'OwnerEmail', 'FeedImageUrl', 'FeedAuthor', 'CreatedAt', 'UpdatedAt', 'CustomData', 'DisplayInSearch', 'EnforceEntitlement', 'PrivacyContext', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'intId', 'partnerId', 'playlistId', 'name', 'status', 'type', 'landingPage', 'flavorParamId', 'playerUiconfId', 'allowEmbed', 'adultContent', 'transcodeExistingContent', 'addToDefaultConversionProfile', 'categories', 'feedDescription', 'language', 'feedLandingPage', 'ownerName', 'ownerEmail', 'feedImageUrl', 'feedAuthor', 'createdAt', 'updatedAt', 'customData', 'displayInSearch', 'enforceEntitlement', 'privacyContext', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::INT_ID, self::PARTNER_ID, self::PLAYLIST_ID, self::NAME, self::STATUS, self::TYPE, self::LANDING_PAGE, self::FLAVOR_PARAM_ID, self::PLAYER_UICONF_ID, self::ALLOW_EMBED, self::ADULT_CONTENT, self::TRANSCODE_EXISTING_CONTENT, self::ADD_TO_DEFAULT_CONVERSION_PROFILE, self::CATEGORIES, self::FEED_DESCRIPTION, self::LANGUAGE, self::FEED_LANDING_PAGE, self::OWNER_NAME, self::OWNER_EMAIL, self::FEED_IMAGE_URL, self::FEED_AUTHOR, self::CREATED_AT, self::UPDATED_AT, self::CUSTOM_DATA, self::DISPLAY_IN_SEARCH, self::ENFORCE_ENTITLEMENT, self::PRIVACY_CONTEXT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'int_id', 'partner_id', 'playlist_id', 'name', 'status', 'type', 'landing_page', 'flavor_param_id', 'player_uiconf_id', 'allow_embed', 'adult_content', 'transcode_existing_content', 'add_to_default_conversion_profile', 'categories', 'feed_description', 'language', 'feed_landing_page', 'owner_name', 'owner_email', 'feed_image_url', 'feed_author', 'created_at', 'updated_at', 'custom_data', 'display_in_search', 'enforce_entitlement', 'privacy_context', ),
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(syndicationFeedPeer::UPDATED_AT);
		$criteria->addSelectColumn(syndicationFeedPeer::CUSTOM_DATA);
		$criteria->addSelectColumn(syndicationFeedPeer::DISPLAY_IN_SEARCH);
		$criteria->addSelectColumn(syndicationFeedPeer::ENFORCE_ENTITLEMENT);
		$criteria->addSelectColumn(syndicationFeedPeer::PRIVACY_CONTEXT);
	}
	...
	public static function addInstanceToPool(syndicationFeed $obj, $key = null)
	{
		if ( Propel::isInstancePoolingEnabled() )
		{
				...
				)
			{
				...
				vMemoryManager::registerPeer('syndicationFeedPeer');
			}
		}
	}
