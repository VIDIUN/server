...
abstract class BaseConversionParamsPeer {
	...
	public static function &getCriteriaFilter()
	{
		...
		$partnerCriteria = myPartnerUtils::getPartnerCriteriaParams('ConversionParams');
		if ($partnerCriteria)
		{
			call_user_func_array(array('ConversionParamsPeer','addPartnerToCriteria'), $partnerCriteria);
		}
	...
	public static function addInstanceToPool(ConversionParams $obj, $key = null)
	{
		if ( Propel::isInstancePoolingEnabled() )
		{
				...
				)
			{
				...
				vMemoryManager::registerPeer('ConversionParamsPeer');
			}
		}
	}
