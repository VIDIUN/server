...
abstract class BaseSchedulerConfigPeer {
	...
	{		
		$criteriaForSelect = SchedulerConfigPeer::prepareCriteriaForSelect($criteria);
		...
		$queryResult = SchedulerConfigPeer::populateObjects(BasePeer::doSelect($criteriaForSelect, $con));
	...
	public static function &getCriteriaFilter()
	{
		...
		$partnerCriteria = myPartnerUtils::getPartnerCriteriaParams('SchedulerConfig');
		if ($partnerCriteria)
		{
			call_user_func_array(array('SchedulerConfigPeer','addPartnerToCriteria'), $partnerCriteria);
		}
	...
	public static function addInstanceToPool(SchedulerConfig $obj, $key = null)
	{
		if ( Propel::isInstancePoolingEnabled() )
		{
				...
				)
			{
				...
				vMemoryManager::registerPeer('SchedulerConfigPeer');
			}
		}
	}
