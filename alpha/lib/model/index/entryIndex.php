	...
	public static function getIndexFieldsMap()
	{
		if (!self::$fieldsMap)
		{
			self::$fieldsMap = array(
				...
				'entitled_vusers_publish' => 'entitledVusersPublish',
				'entitled_vusers_edit' => 'entitledVusersEdit',
				'entitled_vusers' => 'entitledVusers',
				'entitled_vusers_view' => 'entitledVusersView',
				'privacy_by_contexts' => 'privacyByContexts',
				'creator_vuser_id' => 'creatorVuserId',
	...
	public static function getIndexFieldTypesMap()
	{
		if (!self::$typesMap)
		{
			self::$typesMap = array(
				...
				'vshow_id' => IIndexable::FIELD_TYPE_STRING,
				...
				'entitled_vusers_publish' => IIndexable::FIELD_TYPE_STRING,
				'entitled_vusers_edit' => IIndexable::FIELD_TYPE_STRING,
				'entitled_vusers' => IIndexable::FIELD_TYPE_STRING,
				'entitled_vusers_view' => IIndexable::FIELD_TYPE_STRING,
				'privacy_by_contexts' => IIndexable::FIELD_TYPE_STRING,
				'creator_vuser_id' => IIndexable::FIELD_TYPE_STRING,
	...
	public static function getIndexNullableList()
	{
		if (!self::$nullableFields)
		{
			self::$nullableFields = array(
				...
				'replaced_entry_id',
				'roots',
				'entitled_vusers_publish',
				'entitled_vusers_edit',
				'entitled_vusers',
				'entitled_vusers_view',
				'privacy_by_contexts',
			);
		}
	...
	public static function getIndexSearchableFieldsMap()
	{
		if (!self::$searchableFieldsMap)
		{
			self::$searchableFieldsMap = array(
				...
				'entry.ENTITLED_VUSERS_PUBLISH' => 'entitled_vusers_publish',
				'entry.ENTITLED_VUSERS_EDIT' => 'entitled_vusers_edit',
				'entry.ENTITLED_VUSERS' => 'entitled_vusers',
				'entry.ENTITLED_VUSERS_VIEW' => 'entitled_vusers_view',
				'entry.PRIVACY_BY_CONTEXTS' => 'privacy_by_contexts',
				'entry.CREATOR_VUSER_ID' => 'creator_vuser_id',
