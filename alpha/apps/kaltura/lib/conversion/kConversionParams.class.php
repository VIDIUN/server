 ...
 * This data will be passed to the actual vConversionEngine that will be incharge of using the data to create 
...
class vConversionParams
{
	...
	public $id = "" ; 			// a string representing this set of params (can easily be pointed to by a vConversionProfile) 
	...
	public $file_suffix = ""; 	// will be used together with the target from the vConversionCommand to create a good name for the conversion
