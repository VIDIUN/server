 ...
 * @subpackage propel
 */
class VidiunPeerBuilder extends PHP5PeerBuilder 
{	
	const VIDIUN_COLUMN_PARTNER_ID = 'partner_id';
	const VIDIUN_COLUMN_DISPLAY_IN_SEARCH = 'display_in_search';
...
";
	...
	{";
		...
		$table = $this->getTable();
		$partnerIdColumn = $table->getColumn(self::VIDIUN_COLUMN_PARTNER_ID);
		$displayInSearchColumn = $table->getColumn(self::VIDIUN_COLUMN_DISPLAY_IN_SEARCH);
	...
	public static function addInstanceToPool(".$this->getObjectClassname()." \$obj, \$key = null)
	{
		if ( Propel::isInstancePoolingEnabled() )
		{
				...
				)
			{
				...
				vMemoryManager::registerPeer('".$this->getPeerClassname()."');
			}
		}
	}
";
