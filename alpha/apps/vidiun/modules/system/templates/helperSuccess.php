...
<form method="post">
	...
	<ul style='list-style:none; margin:10px; padding: 5px;'>
		...
		<li><input type="radio" id="algo" name="algo" value="vs" <?php echo $algo == "vs" ? "checked='checked'" : "" ; ?> >VS</li>
		<li><input type="radio" id="algo" name="algo" value="vwid" <?php echo $algo == "vwid" ? "checked='checked'" : "" ; ?> >vwid (wiki)   secret: <input type="text" name="secret" value="<?php echo  $secret ?>"></li> 
