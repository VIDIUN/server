<?php
	$multi_request_1 = array (
		...
		array ( "request2_vs" , "" , "40" , "{response1.result.vs}" ) ,
		array ( "request3_service" , "" , "15" , "updateentry" ) ,
		array ( "request3_vs" , "" , "40" , "{response1.result.vs}" ) ,
	...
	$multi_request_2 = array (
		...
		array ( "request2_service" , "" , "15" , "getvshow" ) ,
		array ( "request2_vshow_id" , "" , "30" , "{response1.result.entry.vshowId}" ) ,			
		array ( "request3_service" , "" , "15" , "getallentries" ) ,
		array ( "request3_vshow_id" , "" , "30" , "{response2.result.vshow.id}" ) ,
