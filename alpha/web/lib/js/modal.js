...
{
	windowobject_id_to_remove = obj_id;
}
...
//alert("vidiunInitModalBox ( " + url + "," + options + ")");
//	vidiunCloseModalBox();
...
//		$("#overlay").click(function(){ vidiunCloseModalBox(); });
	}
...
//	alert("return objModalboxContent = " + objModalboxContent);
