...
<head>
<title>Vidiun - XML Schema Documentation</title>
...
<script type="text/javascript">
		$(function() {
			$(window).resize(function(){
				$(".left").css("height", $("body").outerHeight() - $("#vmcSubMenu").outerHeight({ "margin": true }) - 10);
				$(".right").css("height", $("body").outerHeight() - $("#vmcSubMenu").outerHeight({ "margin": true }) - 10);
			});
			$(window).resize();
		});
	</script>
